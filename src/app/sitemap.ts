...
const routes: Array<{ path: string; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency']; priority: number }> = [
  ...
  { path: '/destinations/dubai', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/destinations/abu-dhabi', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/destinations/sharjah', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/destinations/ras-al-khaimah', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/destinations/fujairah', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/destinations/al-ain', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/destinations/umm-al-quwain', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/destinations/united-arab-emirates', changeFrequency: 'weekly', priority: 0.8 },
  { path: '/destinations/makkah', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/destinations/saudi-arabia', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/destinations/musandam', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/destinations/oman', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/destinations/tbilisi', changeFrequency: 'weekly', priority: 0.5 },
  { path: '/destinations/georgia', changeFrequency: 'weekly', priority: 0.6 },
