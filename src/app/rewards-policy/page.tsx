...
const earn: [string, string][] = [
  ...
  ['Refer a friend (they sign up)', '25,000'],
  ['Your referred friend makes their first booking', '50,000'],
    ...
    <div className="container-xl py-16 max-w-3xl">
      ...
      <section className="mb-10">
        ...
        <p className="text-neutral-700 mt-4">
          ...
          away and become available to redeem once you complete your first booking.
        </p>
