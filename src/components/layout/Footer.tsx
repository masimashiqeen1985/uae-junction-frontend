...
// Official UAE Junction profiles (sourced from theuaejunction.com footer).
// Blank platforms are intentionally omitted — SocialIcons auto-hides anything
// without a real URL, so no dead links ship. Add more here (or via CMS
// siteOptions.socialLinks once ACF is configured) to light up extra platforms.
...
{ platform: 'TikTok', url: 'https://www.tiktok.com/@theuaejunction2' },
{ platform: 'YouTube', url: 'https://youtube.com/@theuaejunction' },
{ platform: 'Pinterest', url: 'https://www.pinterest.com/theuaejunction/' },
...
<NewsletterForm />
<div className="mt-6">
<p className="mb-3 text-xs font-semibold uppercase tracking-wider text-neutral-500">Follow us</p>
<SocialIcons links={opt.socialLinks} />
</div>
<a
