          ...
          <div className="flex h-16 items-center justify-between lg:h-20">
            ...
            <div className="flex items-center gap-1.5 sm:gap-3">
              ...
              <a
                ...
                className={`focus-ring hidden items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-bold transition-colors hover:text-[var(--c-primary)] sm:flex ${textColor}`}
              >
