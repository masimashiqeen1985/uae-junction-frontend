...
export function VibrantHome() {
  ...
  return (
    <div className="vibrant-home" ref={root}>
      ...
      <a className="card reveal" href="https://www.theuaejunction.cloud/product/dubai-aquarium-underwater-zoo-ocean-wonders"><div className="imgwrap"><img alt="Dubai Aquarium and Underwater Zoo" src="https://i0.wp.com/theuaejunction.com/wp-content/uploads/2025/04/Dubai-Aquarium-Under-Water-Zoo-1.jpg?w=700&ssl=1" /><div className="badges"><span className="pill pill-hot">-6%</span><span className="pill pill-cash">2.5% back</span></div><div className="heart">♡</div></div>
      ...
      <a className="card reveal" href="https://www.theuaejunction.cloud/product/global-village-dubai"><div className="imgwrap"><img alt="Global Village Dubai" src="https://i0.wp.com/theuaejunction.com/wp-content/uploads/2025/04/Global-Village-1.webp?w=700&ssl=1" /><div className="badges"><span className="pill pill-hot">-10%</span><span className="pill pill-cash">2.5% back</span></div><div className="heart">♡</div></div>
