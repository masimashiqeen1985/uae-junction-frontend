...
export const GET_POST=`query GetPost($slug:ID!){post(id:$slug,idType:SLUG){id slug title date content excerpt featuredImage{node{${MEDIA_FIELDS}}}categories{nodes{name slug}}author{node{name}}}}`
