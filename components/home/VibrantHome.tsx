...
import { AuthDropdown } from '@/components/auth'
...
export function VibrantHome() {
  ...
  return (
    <div className="vibrant-home" ref={root}>
      ...
      <a className="brand" href="#" aria-label="The UAE Junction">The UAE <b>Junction</b></a>
      <div className="nav-links">
        <a href="/promotion">Hot Deals</a>
        <div className="nav-dropdown">
          <a href="/experiences" className="nav-dropdown-trigger">Explore &amp; Book <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true"><path d="M2 4l4 4 4-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg></a>
          <div className="nav-dropdown-menu">
            <a href="/desert-safari-packages">Desert Safari</a>
            <a href="/dubai-dhow-cruise">Dhow Cruise</a>
            <a href="/theme-parks">Theme Parks</a>
            <a href="/water-park-tickets">Water Parks</a>
            <a href="/uae-city-tours">City Tours</a>
            <a href="/umrah-packages">Umrah Packages</a>
            <a href="/hotel-booking">Hotels</a>
            <a href="/flight-booking">Flights</a>
          </div>
        </div>
        <a href="/blogs">Blogs</a>
      </div>
      <div className="nav-cta">
        <a className="nav-wallet" href="#wallet" aria-label="My Wallet">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="2" y="7" width="20" height="14" rx="3" stroke="currentColor" strokeWidth="1.8"/><path d="M16 14a1 1 0 1 0 2 0 1 1 0 0 0-2 0Z" fill="currentColor"/><path d="M2 11h20M7 7V5a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>
          <span className="nav-wallet-amount">AED 0.00</span>
        </a>
        <AuthDropdown labels={{ triggerText: 'Sign In' }} callbackUrl="/" />
      </div>
      ...
      <a className="cat" href="#"><div className="emoji">🎢</div><div className="t">Theme Parks</div><div className="c">28 attractions</div></a>
      <a className="cat" href="#"><div className="emoji">🏜️</div><div className="t">Desert Safari</div><div className="c">41 tours</div></a>
      <a className="cat" href="#"><div className="emoji">🚤</div><div className="t">Dhow Cruise</div><div className="c">19 cruises</div></a>
      <a className="cat" href="#"><div className="emoji">💦</div><div className="t">Water Parks</div><div className="c">12 parks</div></a>
      <a className="cat" href="#"><div className="emoji">🏙️</div><div className="t">City Tours</div><div className="c">34 tours</div></a>
      ...
      <a className="cat" href="#"><div className="emoji">🕋</div><div className="t">Umrah</div><div className="c">Packages</div></a>
      </div></div>
      ...
      <div className="cards">
      <a className="card reveal" href="https://theuaejunction.com/yas-island-4-theme-park-tickets-combo-pass/"><div className="imgwrap"><img alt="Yas Island 4 Theme Park Tickets Combo Pass" src="https://i0.wp.com/theuaejunction.com/wp-content/uploads/2025/06/SEA-FERRARI-YAS-WARNER-BROS.jpg?w=700&ssl=1" /><div className="badges"><span className="pill pill-hot">-13%</span><span className="pill pill-cash">4% back</span></div><div className="heart">♡</div></div>
      ...
      <a className="card reveal" href="https://theuaejunction.com/ferrari-world-plus-seaworld-abu-dhabi-combo/"><div className="imgwrap"><img alt="Ferrari World Plus SeaWorld Abu Dhabi Combo" src="https://i0.wp.com/theuaejunction.com/wp-content/uploads/2025/05/Ferrari-World-SeaWorld-Abu-Dhabi-Combo-Package.webp?w=700&ssl=1" /><div className="badges"><span className="pill pill-hot">-7%</span><span className="pill pill-cash">4% back</span></div><div className="heart">♡</div></div>
      ...
      <a className="card reveal" href="https://theuaejunction.com/dubai-aquarium-underwater-zoo-ocean-wonders/"><div className="imgwrap"><img alt="Dubai Aquarium and Underwater Zoo" src="https://i0.wp.com/theuaejunction.com/wp-content/uploads/2025/04/Dubai-Aquarium-Under-Water-Zoo-1.jpg?w=700&ssl=1" /><div className="badges"><span className="pill pill-hot">-6%</span><span className="pill pill-cash">4% back</span></div><div className="heart">♡</div></div>
      ...
      <a className="card reveal" href="https://theuaejunction.com/global-village-dubai/"><div className="imgwrap"><img alt="Global Village Dubai" src="https://i0.wp.com/theuaejunction.com/wp-content/uploads/2025/04/Global-Village-1.webp?w=700&ssl=1" /><div className="badges"><span className="pill pill-hot">-10%</span><span className="pill pill-cash">4% back</span></div><div className="heart">♡</div></div>
      ...
      <a className="show-card reveal" href="#"><img alt="Theme park rollercoaster at IMG Worlds" src="https://i0.wp.com/theuaejunction.com/wp-content/uploads/2025/04/dolphins-performing-dolphin-show-with-their-trainers-national-zoo.jpg?w=1100&ssl=1" />
      ...
      <a className="show-card reveal" href="#"><img alt="Camels and 4x4 at sunset in the desert" src="https://i0.wp.com/theuaejunction.com/wp-content/uploads/2025/04/high-angle-view-off-road-vehicle-desert.jpg?w=1100&ssl=1" />
      ...
      <div className="enq-tabs"><button type="button" className="enq-tab active">🏨 Hotel</button><button type="button" className="enq-tab">✈️ Flight</button><button type="button" className="enq-tab">🧳 Both</button></div>
      <div className="enq-row"><label>Destination<input placeholder="Dubai, Istanbul…" /></label><label>Travellers<input placeholder="2 adults" /></label></div>
      ...
      <label className="enq-full">Your WhatsApp or email<input placeholder="+971 50… or you@email.com" /></label>
      <button className="btn btn-grad enq-submit">Request my quote →</button>
      ...
      <div className="wc-row"><span><i>💸</i> Cashback earned</span><b>AED 247.50</b></div>
      <div className="wc-row"><span><i>🎁</i> Joining bonus</span><b>AED 25.00</b></div>
      <div className="wc-row"><span><i>🤝</i> Referral bonus <small>(2 friends)</small></span><b>AED 40.00</b></div>
      </div>
      <div className="wc-foot"><span>No expiry · no minimum</span><a href="#">Use at checkout →</a></div>
      </div>
      </div>
      <div>
